...
// re-apply the portrait crop+transform after mesa builds its swapchain (imports.c
// calls this post-eglCreateWindowSurface and for the first frames) so the rotation
// isn't lost to mesa resetting the NWindow (fixes "zoomed in" portrait presentation).
